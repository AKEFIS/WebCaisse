...
public class LiaisonConsommateur extends javax.swing.JFrame {
    ...
    private void LiaisonConsommateurButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LiaisonConsommateurButtonActionPerformed
        ...
        try (java.sql.Connection connexion = connectDB.getConnection(); PreparedStatement statement = connexion.prepareStatement(sql)) {

            statement.setInt(1, Integer.parseInt(IDConsommateurTextField.getText()));
            statement.setInt(2, pointDeVente.getIdPointDeVente());
            statement.setInt(3, Integer.parseInt(PointsDeFideliteTextField.getText()));

            statement.executeUpdate();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(this, "Erreur lors de la liaison", "Erreur", JOptionPane.ERROR_MESSAGE);
            this.dispose();
            e.printStackTrace();
        }
